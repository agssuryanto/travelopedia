                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $userdata->name }}" class="form-control" id="user_name" name="user_name" placeholder="User Name" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" value="{{ $userdata->email }}" class="form-control" id="email_address" name="email_address" placeholder="Email Address" />
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-6">
                                            <div class="form-group">
                                                <label class="form-label">Phone No</label>
                                                <input type="text" value="{{ $userdata->phone_no }}" class="form-control" id="phone_no" name="phone_no" placeholder="Phone No" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="user_bio" id="user_bio">{{ $userdata->bio }}</textarea>
                                    </div>
