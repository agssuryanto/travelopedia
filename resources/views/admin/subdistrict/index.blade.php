            ...
            <div class="card">
                ...
                <!-- div class="card-header" -->
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3">
                            <form method="post" action="{{ route('subdistrict.newdata') }}">
                                @csrf
                        ...
                        $("#tblcity").find("tr:gt(0)").remove();
                            ...
                            if ( district.length > 0 ) {
                                ...
                                $.each(district, function(idx, obj) {
                                    ...
                                    var edit = "<a href=<?php echo config('app.url'); ?>" + "/admin/subdistrict/" + obj.id + "/edit class='icon'><i class='fe fe-edit'></i></a>";
                                    var del = "<a href=<?php echo config('app.url'); ?>" + "/admin/subdistrict/" + obj.id + " class='icon'><i class='fe fe-trash'></i></a>";
                                    $('#tblcity > tbody:last-child').append('<tr><td>'+xx+'</td><td>'+obj.subdistrict_name+'</td><td>'+obj.zip_code+'</td><td>'+status+'</td><td>'+edit+'</td><td>'+del+'</td></tr>');
                                });
                            }
                    } else {
