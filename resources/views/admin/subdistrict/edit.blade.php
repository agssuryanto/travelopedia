                ...
                <div class="card">
                    ...
                    <form id="frmAddCity" name="frmAddCity">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="subdistrict_name" name="subdistrict_name" placeholder="Sub District Name" value="{{ $key->subdistrict_name }}" />
                        </div>
                        ...
                        <input type="hidden" class="form-control" id="c_id" name="c_id" value="{{ $key->city_id }}" />
                        <input type="hidden" class="form-control" id="d_id" name="d_id" value="{{ $key->district_id }}" />
                        <input type="hidden" class="form-control" id="id" name="id" value="{{ $key->id }}" />
