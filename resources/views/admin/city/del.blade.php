        ...
        <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Confirmation Delete City</h3>
                    </div>
                    ...
                    <form id="frmEditProvince" name="frmEditProvince">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="city_name" name="city_name" placeholder="City Name" value="{{ $key->city_name }}" />
                        </div>
