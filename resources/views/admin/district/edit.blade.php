                ...
                <div class="card">
                    ...
                    <form id="frmAddCity" name="frmAddCity">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="district_name" name="district_name" placeholder="District Name" value="{{ $key->district_name }}" />
                        </div>
...
<script type="text/javascript">
    ...
    $('#frmAddCity').on('submit', function(e) {
        ...
        if ( $('#district_name').val() == '' || $('#status').val() =='' ) {
