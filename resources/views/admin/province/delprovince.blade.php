        ...
        <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Confirmation Delete Province</h3>
                    </div>
                    ...
                    <form id="frmEditProvince" name="frmEditProvince">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="province_name" name="province_name" placeholder="Province Name" value="{{ $key->province_name }}" />
                        </div>
