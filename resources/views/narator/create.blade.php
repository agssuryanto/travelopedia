...
<div class="page">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <textarea class="form-control" id="wysiwyg" name="wysiwyg">{{ $datax->text_currator }}</textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="hidden" class="form-control" id="posts_id" name="posts_id" value="{{ $datax->id }}">
                <input type="hidden" class="form-control" id="narasi_id" name="narasi_id" value="">
