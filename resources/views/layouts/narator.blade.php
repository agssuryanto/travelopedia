        ...
        <div class="container">
            <div class="d-flex row">
                <div class="footer-menu text-center">
                    <a href="{{ route('narator.home') }}"><i class="icon ion-md-home"></i></a>
                </div>
                <div class="footer-menu text-center">
                    <a href="{{ route('narator.log') }}"><i class="icon ion-md-time"></i></a>
                </div>
                <div class="footer-menu text-center">
                    <a href="{{ route('narator.posts') }}"><i class="icon ion-md-add-circle-outline"></i></a>
                </div>
                <div class="footer-menu text-center">
                    <a href="#"><i class="icon ion-md-heart-empty"></i></a>
                </div>
                <div class="footer-menu text-center">
                    <a href="{{ route('narator.profile') }}"><i class="icon ion-md-person"></i></a>
                </div>
            </div>
        </div>
    </footer>
